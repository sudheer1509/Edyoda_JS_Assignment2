...
heading1.appendChild(h2);
heading1.style.margin = "20px";

productList(clothList, row1);

var heading2 = document.getElementById("heading2");
var row2 = document.getElementById("row2");

var h2 = document.createElement("h2");
h2.innerText = "Accessories for Men and Women";
heading2.appendChild(h2);
heading2.style.margin = "20px";

productList(accessoriesList, row2);

function productList(list, row) {
